...
int main()
{
    ...
    cin>>r1;
    cout<<"Enter no. of columns of 1st matrix (between 1-100 only): ";
    cin>>c1;
    cout<<endl;
    cout<<"Enter no. of rows of 2nd matrix (between 1-100 only): ";
    cin>>r2;
    cout<<"Enter no. of columns of 2nd matrix (between 1-100 only): ";
    cin>>c2;
    if(r1!=r2 || c1!=c2)
    {
        cout<<endl<<"Invalid Input! Enter same number of rows & columns!"<<endl<<endl;
        temp=0;
    }
    else
    {
